...
async function loadGames() {
    const gameFolders = ['/games/SmashKarts', '/games/Minecraft', '/games/Uno', '/games/1v1lolold', '/games/1v1lolnew', '/games/BaldiBasics', '/games/ClickerHeros', '/games/CrossyBacon', '/games/MicroWars', '/games/pubgm', '/games/SubwaySurfers', '/games/ThumbFighter']; // Only Smash Karts for now
